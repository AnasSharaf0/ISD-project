...
<td style="font-size:15px; padding:5px; font-weight:bold;">date</td>
</tr>

<?php

// $s="select * from booking";
$s="SELECT user_booking.id, users.username, package.Packname,package.Packprice,user_booking.date
    FROM ((user_booking
    INNER JOIN users ON user_booking.user_id = users.id)
